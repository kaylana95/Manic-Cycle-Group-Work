...
<nav class="navbar navbar-inverse" style="margin-top:-18px;">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            ...
            <li class="active">
                <a href="quote.php"><span class="glyphicon glyphicon-object-align-vertical"></span> Quote
                </a>
            </li>

            <li>
                <a href="client.php"><span class="glyphicon glyphicon-user"></span> Client</a>
            </li>
